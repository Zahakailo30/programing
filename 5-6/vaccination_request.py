...
class Vaccination_request:
    def __init__(self, id_=4444, patient_name_ = 'oleksa', patient_phone_ = '+380981234567',
                 vaccine_ = 'phizer', date_ = '12/12/2021', start_time_ = '12:11',
                 end_time_ = '12:22'):
        self.set_id(id_)
        self.set_patient_name(patient_name_)
        self.set_patient_phone(patient_phone_)
        self.set_vaccine(vaccine_)
        self.set_date(date_)
        self.set_start_time(start_time_)
        self.set_end_time(end_time_)
